		  ...
		  do{
		    ...
		    switch(eleccion)
		    {
		        case 1:
		            ...
		            int sel;
		            cout << "Indique el lenguaje con el que quiere operar: 1 ó 2 >>  ";
		            cin >> sel;
		            if(sel == 1) CLF.potencia(n, Len1);
		            if(sel == 2) CLF.potencia(n, Len2);
		        break;
		        ...
		        case 2:
		            ...
		            cout << "Indique el lenguaje con el que quiere operar: 1 ó 2 >>  ";
		            cin >> sel2;
		            if(sel2 == 1) CLF.inversa(Len1);
		            if(sel2 == 2) CLF.inversa(Len2);
